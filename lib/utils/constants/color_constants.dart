...
class ColorConstants {
  static const Color primaryColor = Color(0xFF49b1fc); //light blue
  static const Color saveButtonColor = Color(0xFF48a6ea); //save button
  ...
  static const Color loginButtonColor = Color(0xFF425FEB);
}
